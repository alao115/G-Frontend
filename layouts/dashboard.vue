    ...
    <div :class="isMinified ? 'ml-16' : 'lg:ml-64'" class="flex flex-col w-full">
      <div class="flex items-center justify-between h-16 px-8 w-full -z-10 bg-white">
        ...
        <div class="flex justify-center items-center space-x-4">
          <button v-if="connectedUser && (connectedUser.user.userType === userRole.REGULAR_USER)" class="hidden lg:flex btn flex space-x-4 items-center justify-center h-10 px-4 ml-2 text-sm font-medium bg-sky-550 text-white rounded hover:bg-blue-920" @click="switchingModalIsOpen = true">
