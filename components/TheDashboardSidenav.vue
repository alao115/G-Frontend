<template>
  <div class="fixed flex flex-col items-center h-full overflow-hidden text-gray-700 rounded border-r-2 border-gray-200 flex-none z-50" :class="isMinified === true ? 'w-16' : 'w-64'">
